...
//	private PaymentMethod paymentMethod;
	...
	public Order(UUID clientId,  Address billingAddress, Address shippingAddress) {//public Order(UUID clientId, PaymentMethod paymentMethod, Address billingAddress, Address shippingAddress) {
